...
DateTime _shiftDate(DateTime date, int days) => _startOfDay(date.add(Duration(days: days)));
  ...
  Widget build(BuildContext context) {
    ...
    if (!canView) {
      return const EmptyState(
        ...
        description: 'Employee attendance details are available to admins and managers only.',
      );
    }
    ...
    final statusText = _attendance?.statusDescription ?? 'Unknown';
    final isPresent = statusText.toLowerCase().contains('present');
    final isAbsent = statusText.toLowerCase().contains('absent');
    final isLate = statusText.toLowerCase().contains('late');
    final isLeave = statusText.toLowerCase().contains('leave');
                    ...
                    child: Row(
                      ...
                      children: [
                        Container(
                          ...
                          child: const Icon(Icons.circle, color: Colors.white, size: 22),
                        ),
                        const SizedBox(width: 16),
                        Expanded(
                          child: Column(
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Text(
                              (_attendance!.employeeType ?? 'employee').toUpperCase(),
                              style: const TextStyle(
                                color: Colors.white,
                                fontWeight: FontWeight.w700,
                              ),
                    ...
                    GridView.count(
                      ...
                      children: [
                        ...
                        _SimpleField(
                          ...
                          value: _attendance!.requestedLeaveTypeDescription ?? '—',
                        ),
                        _SimpleField(
